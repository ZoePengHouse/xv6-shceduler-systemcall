...
801056cb:	e8 50 f2 ff ff       	call   80104920 <argint>
801056d0:	83 c4 10             	add    $0x10,%esp
801056d3:	85 c0                	test   %eax,%eax
801056d5:	78 69                	js     80105740 <sys_getparentname+0xb0>
	{
		return -1;
	}
...
801056e0:	e8 3b f2 ff ff       	call   80104920 <argint>
801056e5:	83 c4 10             	add    $0x10,%esp
801056e8:	85 c0                	test   %eax,%eax
801056ea:	78 54                	js     80105740 <sys_getparentname+0xb0>
	{
		return -1;
	}
	// check buffer
        if (parentbuf == NULL || childbuf == NULL)
801056ec:	8b 5d e8             	mov    -0x18(%ebp),%ebx
801056ef:	85 db                	test   %ebx,%ebx
801056f1:	74 4d                	je     80105740 <sys_getparentname+0xb0>
801056f3:	8b 4d ec             	mov    -0x14(%ebp),%ecx
801056f6:	85 c9                	test   %ecx,%ecx
801056f8:	74 46                	je     80105740 <sys_getparentname+0xb0>
        {
                return -1;
        }
        // check size
...
801056fd:	85 d2                	test   %edx,%edx
801056ff:	7e 3f                	jle    80105740 <sys_getparentname+0xb0>
80105701:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105704:	85 c0                	test   %eax,%eax
80105706:	7e 38                	jle    80105740 <sys_getparentname+0xb0>
        {
                return -1;
        }
        // get my process
...
80105708:	e8 63 e2 ff ff       	call   80103970 <myproc>
        ...
        safestrcpy(parentbuf, parentproc->name, parentbufsize);
8010570d:	83 ec 04             	sub    $0x4,%esp
80105710:	ff 75 f0             	push   -0x10(%ebp)
        struct proc *curproc = myproc();
80105713:	89 c3                	mov    %eax,%ebx
        safestrcpy(parentbuf, parentproc->name, parentbufsize);
80105715:	8b 40 14             	mov    0x14(%eax),%eax
        safestrcpy(childbuf, curproc->name, childbufsize);
80105718:	83 c3 6c             	add    $0x6c,%ebx
        safestrcpy(parentbuf, parentproc->name, parentbufsize);
8010571b:	83 c0 6c             	add    $0x6c,%eax
8010571e:	50                   	push   %eax
8010571f:	ff 75 e8             	push   -0x18(%ebp)
80105722:	e8 f9 f0 ff ff       	call   80104820 <safestrcpy>
        safestrcpy(childbuf, curproc->name, childbufsize);
80105727:	83 c4 0c             	add    $0xc,%esp
8010572a:	ff 75 f4             	push   -0xc(%ebp)
8010572d:	53                   	push   %ebx
8010572e:	ff 75 ec             	push   -0x14(%ebp)
80105731:	e8 ea f0 ff ff       	call   80104820 <safestrcpy>
        return 0;
80105736:	83 c4 10             	add    $0x10,%esp
80105739:	31 c0                	xor    %eax,%eax
...
80105745:	eb f4                	jmp    8010573b <sys_getparentname+0xab>
